...
//=============================================================================
 /*:
 * @plugindesc 【Yep系列】主菜单命令管理插件|功能类
 ...
 *  更改主菜单命令的各个方面插件
 *  无需触摸源代码即可使用此插件
 *  可搭配:gameusquestsystem.js[高级任务插件]使用
 * ============================================================================
 *  ▶如何使用此插件                                               (～￣▽￣)～
 * ==================================================		==========================
 *
 *  参数中的每个部分都被划分为不同的部分。每个
 *  这些部分在菜单命令的工作方式中起作用。
 *
 *  Name
 *  -这是命令在主菜单中的显示文字
 *
 *  Symbol
 *  -这是命令的标识符。每个命令都应具有唯一的
 *  符号，以避免与每个命令发生冲突（公共事件）
 *  Show
 *  -这是命令是否显示在主菜单。
 *
 *  Enabled
 ...
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 * 99项 DEBUG 笔记  开关测试
 * show $gameTemp.isPlaytest()   bind this.commandDebug.bind(this)
 * ============================================================================
 * ▶更新                                                          (～￣▽￣)～
 * ============================================================================
 *
